...
StandardToken.prototype = {
    init: function () {
        this._name = "RealityCryptoMonster";
        this._symbol = "RCM";
        var decimals = 18;
        ...
        this._totalFree = this._totalSupply.times(0.01);
        this._singleReceive = new BigNumber(1000).mul(new BigNumber(10).pow(decimals));
        this._freeflag = true;
        this._admin = from;
        this._totalApply = 0;
    },
    getTotalApply:function(){
        return this._totalApply.toString(10);
    },
